...
const ArchiveView: React.FC<ArchiveViewProps> = ({ projects, onView, onDelete }) => {
  if (projects.length === 0) {
    return (
      <div className="text-center py-20">
        <h2 className="text-3xl font-bold text-gray-700">Aún no tenemos proyectos guardados, mi vida</h2>
        <p className="text-gray-500 mt-2">¡Sube una foto para que empecemos a crear!</p>
      </div>
    );
  }
  ...
  return (
    <div className="container mx-auto">
      <h2 className="text-4xl font-bold text-center mb-10 bg-clip-text text-transparent bg-gradient-to-r from-pink-500 to-purple-500">Nuestros Proyectos</h2>
